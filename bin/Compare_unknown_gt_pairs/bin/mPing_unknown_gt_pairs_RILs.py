...
1. both mPing are present in the RILsi (inversion between mPing will be include in this case, as we can not see the difference between original and inversion using reads mapping).
