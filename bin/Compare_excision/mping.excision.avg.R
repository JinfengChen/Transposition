...
library("plotrix")
pdf('mping.excision.avg.pdf')
t <- read.table("mping.excision.avg.table")
std <- t[,3][1:9]
y <- t[,2][1:9]
#y <- append(y,0,0)
#std <- append(std,0,0)
...
axis(2,c(0,20,40,60),line=0,labels=c(0,20,40,60))
...
mtext("Allele Frequency", side=1,cex=1.2, at=5,line=3)
