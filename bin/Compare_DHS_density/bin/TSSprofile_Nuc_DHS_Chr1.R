...
#Nucleosome
plot(nuc[,1]/nreads_nuc/ngene/bandwidth_nuc, type='l', pch= 1,lwd = 2 , col="brown", xaxt='n', frame.plot = FALSE, ylim=c(0.01, 0.03), ylab="Normalized Read count", xlab="")
axis(1,seq(0, 4000, by= 400),line=0, labels=seq(-2, 2, by= 0.4))
mtext("Distance to TSS (kb)", side=1, cex=1.2, at=2000, line=3)
#DHS
plot(dhs[,1]/nreads_dhs/ngene/bandwidth_dhs, type='l', pch= 1,lwd = 2 , col="blue", xaxt='n', frame.plot = FALSE, ylim=c(0.01, 0.05), ylab="Normalized Read count", xlab="")
axis(1,seq(0, 4000, by= 400),line=0, labels=seq(-2, 2, by= 0.4))
mtext("Distance to TSS (kb)", side=1, cex=1.2, at=2000, line=3)
#combined
plot(nuc[,1]/nreads_nuc/ngene/bandwidth_nuc, type='l', pch= 1,lwd = 2 , col="brown", xaxt='n', frame.plot = FALSE, ylim=c(0.01, 0.05), ylab="Normalized Read count", xlab="")
