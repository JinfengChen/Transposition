...
xx <- barplot(y,beside=TRUE,ylab="mPing insertions",cex.lab=1.2, cex.names=1.2, cex.axis=1.2,border=FALSE,axes=FALSE,ylim=c(0,120),col="steelblue2")

b <- 220

axis(1,c(0,2.5,4.8,7.3,9.7,12.1,13.4),line=0,c(0,2,4,6,8,10,"<20"))
...
mtext("Excision events", side=1,cex=1.2, at=6,line=3)
