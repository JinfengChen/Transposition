...
start=`date +%s`
fq1=../input/RILs_ALL_unmapped_mping_fastq3/RIL151/RIL151_1.fq
fq2=../input/RILs_ALL_unmapped_mping_fastq3/RIL151/RIL151_2.fq
...
/opt/linux/centos/7.x/x86_64/pkgs/bwa/0.7.12/bin/bwa aln -t $PBS_NP $ref $fq1 > RIL151.1.sai
/opt/linux/centos/7.x/x86_64/pkgs/bwa/0.7.12/bin/bwa aln -t $PBS_NP $ref $fq2 > RIL151.2.sai
/opt/linux/centos/7.x/x86_64/pkgs/bwa/0.7.12/bin/bwa sampe -a 500 -A $ref RIL151.1.sai RIL151.2.sai $fq1 $fq2 > RIL151.sam
