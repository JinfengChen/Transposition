...
start=`date +%s`
prefix=RIL268
fq1=../input/RILs_ALL_unmapped_mping_fastq/$prefix/$prefix\_1.fq
fq2=../input/RILs_ALL_unmapped_mping_fastq/$prefix/$prefix\_2.fq
...
#python RM_duplicate_reads.py --sam $prefix\.sam
...
#java -Xmx20G -jar /opt/picard/1.81/MarkDuplicates.jar ASSUME_SORTED=TRUE REMOVE_DUPLICATES=TRUE VALIDATION_STRINGENCY=LENIENT INPUT=$prefix.sort.bam OUTPUT=$prefix.bam METRICS_FILE=$prefix.dupli
