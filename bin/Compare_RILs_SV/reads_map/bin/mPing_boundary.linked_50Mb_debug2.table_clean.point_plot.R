...
###plot 100 kb
pdf("mPing_boundary.linked_50Mb_debug2.table_clean.point_plot.pdf")
data =read.table("mPing_boundary.linked_50Mb_debug2.table_clean.rough_removed_early_insertion.txt")
excision1 = data[,8]
excision2 = data[,9]
dist = data[,2]
plot(dist, excision1, col='black', pch=21, cex=2, xlab="Distance (kb)", ylab="#Excision", xlim=c(0, 1000000))
points(dist, excision2, col='black', pch=21, cex=2)
