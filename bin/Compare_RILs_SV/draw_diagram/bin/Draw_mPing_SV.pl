...
my $svg=SVG->new(width=>1200,height=>1000);
my $startw=50; 
my $endw  =1100;
my $starth=100;
my $endh  =500;
...
print "Plot type2\n";
plot_deletion_two_mping($svg, $startw+600, $starth, 'Type 2: Deletions from one mPing insertions to flanking sequence', 'RIL_SV_type2.txt', $scale);
print "Plot type3\n";
plot_deletion_two_mping($svg, $startw, $starth+350, 'Type 3: Deletions accompanied by rearrangement of flanking sequence', 'RIL_SV_type3.txt', $scale);
