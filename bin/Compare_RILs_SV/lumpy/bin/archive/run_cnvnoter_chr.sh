...
/usr/bin/python2.7 cnvnator_wrapper_chr.py --cnvnator /bigdata/stajichlab/cjinfeng/software/SVcaller/speedseq//bin/cnvnator-multi -T cnvnator-temp-wrapper -t 12 -w 100 -b sample.1.fq.bam -o sample.1.fq.bam.readdepth -c /bigdata/stajichlab/cjinfeng/software/SVcaller/speedseq//annotations/cnvnator_chroms
