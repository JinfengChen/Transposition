...
pdf("Excision_Events_distance.boxplot4.pdf", height=7, width=4)
par(mar=c(7,4,4,2))
high <- read.table("Excision_Events_distance.boxplot4.high.txt")
all <- read.table("Excision_Events_distance.boxplot4.all.txt")
...
pvalue(1, 1230000, 2, 400000, 1250000, 1.1e-09)
dev.off()
