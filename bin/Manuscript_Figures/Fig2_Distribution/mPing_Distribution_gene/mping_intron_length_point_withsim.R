...
som <- read.table("../mPing_distr/Somatic.intron.length.distr")
str <- read.table("../mPing_distr/Strains.intron.length.distr")
ril <- read.table("../mPing_distr/RIL.intron.length.distr")
