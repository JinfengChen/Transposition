...
xx <- barplot(data,beside=TRUE,ylab="Proportion",cex.names=1,cex.axis=1,border=FALSE,axes=FALSE,ylim=c(0,0.5),col=c("aquamarine3", "steelblue2" ,"sandybrown", "dim gray"))
...
text(xx[1,]+0.2,rep(-0.08,7), cex=1, offset=2,labels=x1[,2],srt=55,xpd=TRUE)
legend('topright', bty='n', border='NA', lty=c(0,0),cex=1 ,c("Somatic", "RIL", "Landrace", "Simulation"),fill=c("aquamarine3", "steelblue2" ,"sandybrown", "dim gray"))
