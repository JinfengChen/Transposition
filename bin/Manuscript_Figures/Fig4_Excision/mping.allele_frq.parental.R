...
t <- read.table("RIL275_RelocaTEi.CombinedGFF.characterized.clean.mping.ril.parental.frequency")
f <- t[,7]
#f <- f[f>0]
...
xx <- barplot(y,beside=TRUE, ylab="mPing Insertions",cex.lab=1.2, cex.names=1.2, cex.axis=1.2,border=FALSE,axes=FALSE, ylim=c(0, 200), col="steelblue2")
