...
pdf("ping_number_clean_hom_narrow_range.pdf")
par(mar=c(5,5,4,2))
data =read.table("RIL230_RelocaTEi.CombinedGFF.characterized.clean.narrow_range.ping_number.summary")
expr = data[,2]
std = data[,3]
...
#text(3.7, 108, 'R-squared = 0.63, p-value < 4.5e-13', cex=1.4)
#n
