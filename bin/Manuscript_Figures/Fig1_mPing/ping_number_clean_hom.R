...
mtext("Unique", side=2,font=1, at=ypos,line=3, cex=1, col="black")
mtext("mPing", side=2,font=3, at=ypos+13,line=3, cex=1, col="black")
mtext("number", side=2,font=1, at=ypos+27,line=3, cex=1, col="black")
dev.off()
