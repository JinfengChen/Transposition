...
pdf("ping_number_clean_hom_high_depth.pdf")
par(mar=c(5,5,4,2))
data =read.table("RIL230_RelocaTEi.CombinedGFF.characterized.clean.high_depth.ping_number.summary")
expr = data[,2]
std = data[,3]
...
#text(3.7, 108, 'R-squared = 0.76, p-value < 2.2e-16', cex=1.4)
#n
